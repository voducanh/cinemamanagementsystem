...
public class AutomaticRotationNextPeriod implements Runnable {
	...
	public void run() {
		...
		use = new Useful();
		Calendar beginDate = getDateEndPeriod();
		beginDate = use.changeDate(beginDate, 1);
		
		Calendar endDate = getDateEndPeriod();
		endDate = use.changeDate(endDate, 14);
		
		startRotation(beginDate,endDate);
