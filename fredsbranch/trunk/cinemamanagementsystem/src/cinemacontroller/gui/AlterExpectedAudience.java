    		...
    		if(!jTextField1.getText().trim().isEmpty()){
    			...
    			try {
        			...
        			if(!exist){
            			...
            			connection.putData("UPDATE EXPECTED_AUDIENCES SET NAME='"+jTextField1.getText().trim()+"' WHERE NAME='"+jComboBox1.getSelectedItem()+"'");
            	...
            	JOptionPane.showMessageDialog(null, "Please write the new expected audience.", "Invalid Expected Audience", JOptionPane.WARNING_MESSAGE);
            }
    	}
    	else{
