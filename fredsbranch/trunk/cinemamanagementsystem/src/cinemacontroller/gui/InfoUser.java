...
public class InfoUser extends javax.swing.JFrame {
    ...
    public InfoUser(String login, String loginList) {
    	this.login = login;
    ...
    private void initComponents() {
        ...
        try {
			...
			result= connection.getData("SELECT * FROM ACCOUNTS WHERE USERNAME='"+loginList+"'");
			while (result.next()) {
