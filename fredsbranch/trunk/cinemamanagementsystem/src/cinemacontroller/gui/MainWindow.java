...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        create_new_type_menuitem = new javax.swing.JMenuItem();
        create_new_distributor_menuitem = new javax.swing.JMenuItem();
        create_new_exp_menuitem = new javax.swing.JMenuItem();
        alter_film_menuitem = new javax.swing.JMenuItem();
        alter_type_menuitem = new javax.swing.JMenuItem();
        alter_distributor_menuitem = new javax.swing.JMenuItem();
        alter_exp_menuitem = new javax.swing.JMenuItem();
        ...
        create_new_film_button.setToolTipText("Add a film into the database.");
        ...
        jMenu1.setText("New");
        jMenu2.setText("Alter");
        jMenu3.setText("Historical");
        ...
        create_new_type_menuitem.setText("Type");
        create_new_type_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                create_new_type_menuitemActionPerformed(evt);
            }
        });
        jMenu1.add(create_new_type_menuitem);
        
        create_new_distributor_menuitem.setText("Distributor");
        create_new_distributor_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                create_new_distributor_menuitemActionPerformed(evt);
            }
        });
        jMenu1.add(create_new_distributor_menuitem);
        
        create_new_exp_menuitem.setText("Expected Audience");
        create_new_exp_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                create_new_exp_menuitemActionPerformed(evt);
            }
        });
        jMenu1.add(create_new_exp_menuitem);
        
        
        alter_film_menuitem.setText("Film");
        alter_film_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	alter_film_menuitemActionPerformed(evt);
            }
        });
        jMenu2.add(alter_film_menuitem);
        
        alter_type_menuitem.setText("Type");
        alter_type_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	alter_type_menuitemActionPerformed(evt);
            }
        });
        jMenu2.add(alter_type_menuitem);
        
        alter_distributor_menuitem.setText("Distributor");
        alter_distributor_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	alter_distributor_menuitemActionPerformed(evt);
            }
        });
        jMenu2.add(alter_distributor_menuitem);
        
        alter_exp_menuitem.setText("Expected Audience");
        alter_exp_menuitem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	alter_exp_menuitemActionPerformed(evt);
            }
        });
        jMenu2.add(alter_exp_menuitem);
        ...
        jMenu3.add(importHistorical);

        file_menu.add(jMenu1);
        file_menu.add(jMenu2);
        file_menu.add(jMenu3);
    ...
    private void create_new_film_buttonActionPerformed(java.awt.event.ActionEvent evt) {
    	
    	new CreateNewFilm();
    }
    
    private void create_new_type_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
    
    	new CreateNewType();
    }
    
    private void create_new_distributor_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
      
    	new CreateNewDistributor();
    }
    
    private void create_new_exp_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
      
    	new CreateNewExpectedAudience();
    }
    
    private void alter_film_menuitemActionPerformed(java.awt.event.ActionEvent evt) {
 
    }
    
    private void alter_type_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
    	new AlterType();

    }
    
    private void alter_distributor_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
    	new AlterDistributor();

    }
    
    private void alter_exp_menuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_new_film_buttonActionPerformed
    ...
    private javax.swing.JMenuItem create_new_type_menuitem;
    private javax.swing.JMenuItem create_new_distributor_menuitem;
    private javax.swing.JMenuItem create_new_exp_menuitem;
    private javax.swing.JMenuItem alter_film_menuitem;
    private javax.swing.JMenuItem alter_type_menuitem;
    private javax.swing.JMenuItem alter_distributor_menuitem;
    private javax.swing.JMenuItem alter_exp_menuitem;
