...
/**
    ...
    public void updateFilm(Film film) throws SQLException {
        ...
        connection.putData("UPDATE historical_film_list SET title = '" + film.getTitle() + "', director = '" + film.getDirector() + "', bbfc = '" + film.getBBFCRating() + "', length = '" + time_format.format(film.getLength().getTime()) + "', added_date = '" + date_format.format(film.getDateAdded().getTime()) + "', expire_date = '" + date_format.format(film.getExpireDate().getTime()) + "', color = '" + film.getColor() + "', type = '"+film.getType()+"' WHERE `uniqueid` = "+film.getID()+"");
        connection.disconnect();
    }
    ...
    public Film getFilm(int film_id) throws SQLException{
          // Create a new mysql connection and query database
        MySQLController connection = new MySQLController();
        ResultSet result = connection.getData("SELECT * FROM main_film_list WHERE `uniqueid` = '"+film_id+"'");
        Film film = null;
