...
public class EditFilm extends javax.swing.JFrame {
    ...
    public EditFilm(CinemaSystemController controller, MainWindow window, Film current_film) {
        initComponents();
    ...
    public void populateControls(){
        this.jTextField1.setText(current_film.getTitle());
        this.jTextField2.setText(current_film.getDirector());

        this.jComboBox1.setSelectedItem(current_film.getBBFCRating());

        this.expire_day.setText(current_film.getExpireDate().get(Calendar.DAY_OF_MONTH) + "");
        this.expire_month.setText(current_film.getExpireDate().get(Calendar.MONTH) + "");
        this.expire_year.setText(current_film.getExpireDate().get(Calendar.YEAR) + "");

        this.type_combo.setSelectedItem(current_film.getType());

        this.jTextField7.setText(current_film.getLength().get(Calendar.HOUR_OF_DAY) + "");
        this.jTextField8.setText(current_film.getLength().get(Calendar.MINUTE) + "");

        if(current_film.getColor().toUpperCase().equals("BLUE")){ this.buttonGroup1.setSelected(this.blue_color.getModel(), true); }
        if(current_film.getColor().toUpperCase().equals("RED")){ this.buttonGroup1.setSelected(this.red_color.getModel(), true); }
        if(current_film.getColor().toUpperCase().equals("ORANGE")){ this.buttonGroup1.setSelected(this.orange_color.getModel(), true); }
        if(current_film.getColor().toUpperCase().equals("BLACK")){ this.buttonGroup1.setSelected(this.black_color.getModel(), true); }
        if(current_film.getColor().toUpperCase().equals("YELLOW")){ this.buttonGroup1.setSelected(this.yellow_color.getModel(), true); }
        if(current_film.getColor().toUpperCase().equals("GREEN")){ this.buttonGroup1.setSelected(this.green_color.getModel(), true); }
    ...
    private void initComponents() {
        ...
        setTitle("Edit Film Instance - Multiplex Manager");
        ...
        jTextPane_date_description.setText("You can edit a film instance by filling in the boxes to the right.\n\nOnce finished, you can assign a film to a screening.");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel14, javax.swing.GroupLayout.DEFAULT_SIZE, 459, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(type_combo, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((expire_date.getTimeInMillis() - start_date.getTimeInMillis()) >= 1209600000){
            this.createFilmFromDetails(start_date, expire_date);
        
            this.window.updateStatus("Film Updated!");
            
            try {
                this.controller.film_controller.film_database_controller.updateFilm(current_film);
            }catch(Exception e){
                System.out.println("ERROR MOFO:" + e);
            }

            this.window.updateControls();
    ...
    public void createFilmFromDetails(GregorianCalendar start_date, GregorianCalendar expire_date){
        ...
        current_film.updateFilm(title, director, BBFC_rating, length, new GregorianCalendar(), expire_date, selected_color_string, Film.TYPE.valueOf(type));
    }
