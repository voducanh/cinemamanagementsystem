...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Check Viewing Figures");
        ...
        run_action_manager_jbutton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                run_action_manager_jbuttonActionPerformed(evt);
            }
        });
        ...
        create_new_film_button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cinemacontroller/gui/icons/cd_add.png"))); // NOI18N
        ...
        view_actions_jbutton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cinemacontroller/gui/icons/wrench.png"))); // NOI18N
        ...
        view_historical_data_jbutton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cinemacontroller/gui/icons/time.png"))); // NOI18N
    ...
    private void view_statistical_data_jbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view_statistical_data_jbuttonActionPerformed
        new StatisticsWindow(this).setVisible(true);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
         JOptionPane.showMessageDialog(null, "Total Number of Viewings for this screening: " + this.selected_screening.getViewings(), "Viewing Figures for " + this.selected_screening.getFilm().getTitle(), JOptionPane.WARNING_MESSAGE);
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void run_action_manager_jbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_run_action_manager_jbuttonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_run_action_manager_jbuttonActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new RotationEngine(this.core_controller, (DefaultListModel)this.jList1.getModel());
